...
@section('main')
    ...
    <form method="get" action="/shop" id="searchForm">
        <div class="row">
            ...
            <div class="col-sm-2 mb-2">
                <button type="submit" class="btn btn-success btn-block cardShopMaster">Search</button>
            </div>
        </div>
    </form>
    <hr>
    @if ($records->count() == 0)
        <div class="alert alert-danger alert-dismissible fade show">
            Can't find any artist or album with <b>'{{ request()->artist }}'</b> for the genre <b>'{{ request()->genre }}'</b>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
            <div class="card pointer" data-id="{{ $record->id }}">
                ...
                <div class="card-body">
                    ...
                    <a href="shop/{{ $record->id }}" class="btn btn-outline-info btn-sm btn-block cardShopMaster">Show details</a>
                </div>
